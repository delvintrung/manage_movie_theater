...
export default function ZaloPayReturnPage() {
  ...
  useEffect(() => {
    const return_code = params.get('return_code');
    if (return_code === '1') setStatus('success');
      ...
      <div className="max-w-md w-full text-center p-8">
        ...
        {status === 'success' && (
          <>
            ...
            <p className="text-gray-300 mb-6">Thank you! Your ZaloPay payment was successful.</p>
